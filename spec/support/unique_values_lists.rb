...
shared_examples_for 'unique_values_lists' do
  ...
  context '#partitions' do
    ...
    context 'when cluster and partition keys given' do
      ...
      context 'when leaf partition given' do
        it { expect(counter.partitions(cluster1_subcluster1, {:part => :part1, 'subpart' => 'subpart1'})).to have(1).partitions }
        it { expect(counter.partitions(cluster1_subcluster1, {:part => :part1, 'subpart' => 'subpart1'}).first).to eq part1_subpart1 }
      end
    end
  ...
  context '#data' do
    ...
    context 'when cluster and partition keys given' do
      ...
      context 'when leaf partition given' do
        it { expect(counter.data(cluster1_subcluster1, {:part => :part1, 'subpart' => 'subpart1'})).to have(2).rows }
        it { expect(counter.data(cluster1_subcluster1, {:part => :part1, 'subpart' => 'subpart1'})).to include ({'param0' => '1', 'param1' => '2'}) }
        it { expect(counter.data(cluster1_subcluster1, {:part => :part1, 'subpart' => 'subpart1'})).to include ({'param0' => '1', 'param1' => '3'}) }
      end
    end
  ...
  context '#delete_partitions!' do
    ...
    context 'when cluster and partition keys given' do
      ...
      context 'when no partition given' do
        it { expect { counter.delete_partitions!({:cluster => :cluster1, :subcluster => :subcluster1}, {}) }.to raise_error ArgumentError }
      end
      ...
      context 'when not leaf partition given' do
        ...
        it { expect(counter.partitions(cluster1_subcluster1, :part => :part2)).to be_present }
        it { expect(counter.data(cluster1_subcluster1, :part => :part2)).to have(1).rows }
        it { expect(counter.data(cluster1_subcluster1, :part => :part2)).to include ({'param0' => '4', 'param1' => '5'}) }

        it { expect(counter.partitions(cluster2_subcluster1, :part => :part1)).to be_present }
        it { expect(counter.data(cluster2_subcluster1, :part => :part1)).to have(1).rows }
        it { expect(counter.data(cluster2_subcluster1, :part => :part1)).to include ({'param0' => '5', 'param1' => '6'}) }
      end

      context 'when leaf partition given' do
        before { counter.delete_partitions!(cluster1_subcluster1, {:part => :part1, :subpart => :subpart1}) }

        it { expect(counter.partitions(cluster1_subcluster1, {:part => :part1, :subpart => :subpart1})).to have(0).rows }

        it { expect(counter.partitions(cluster1_subcluster1, {:part => :part1, :subpart => :subpart2})).to have(1).rows }
        it { expect(counter.data(cluster1_subcluster1, {:part => :part1, :subpart => :subpart2})).to include ({'param0' => '3', 'param1' => '4'}) }
      end
    end
  end
